...
@section('pageTitle', 'Modifier la/le Country')
...
@section('content')
    ...
    <div class="">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold tracking-tight theme-title">Modifier la/le  Country</h1>
                <p class="mt-0 text-sm theme-muted-text">Mettez à jour les informations de la/le  Country.</p>
        ...
        <div class="theme-surface theme-title border border-gray-200/70 rounded-xl shadow-sm px-6 py-4">
            <form method="POST" action="{{ route('countries.update', $country->id) }}" enctype="multipart/form-data" class="">
                {{ method_field('PATCH') }}
                @csrf
