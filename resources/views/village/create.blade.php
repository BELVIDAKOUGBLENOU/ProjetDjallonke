...
@section('pageTitle', 'Nouvelle Village')
...
@section('content')
    ...
    <div class="">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold tracking-tight theme-title">Créer un(e)  Village</h1>
                <p class="mt-0 text-sm theme-muted-text">Renseignez les informations de la nouvelle  Village.</p>
            </div>
        ...
        <div class="theme-surface theme-title border border-gray-200/70 rounded-xl shadow-sm px-6 py-4">
            <form method="POST" action="{{ route('villages.store') }}" enctype="multipart/form-data" class="">
                @csrf
